 ...
 */
class GupiaoEveryday extends \common\models\gupiao\GupiaoEverydayWangyi
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['last_price', 'turnover_percent', 'deal_money', 'all_market_value', 'liutong_market_value', 'shake_percent', 'shake_value'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'turnover_percent' => $this->turnover_percent,
            ...
            'shake_percent' => $this->shake_percent,
